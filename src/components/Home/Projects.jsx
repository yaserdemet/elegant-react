...
const Projects = () => {
  return (
    ...
    <section class="mb-44 mt-44 w-[80%] mx-auto">
    <div class="grid grid-cols-2 gap-24 projects">
      ...
      <div class=" ">
        <h4 class="text-[#625fd1] dark:text-white text-4xl leading-10 font-semibold mb-8">
          Plan Project In Details With The Task Timeline
        </h4>
        <p className="text-left text-[#707070] dark:text-white mb-8 text-xl">
          Pellentesque habitant morbi tristique senectus et netus et malesuada
          fames ac turpis egestas. Ut arcu libero.
        </p>

        <h5 className="font-medium text-2xl dark:text-white text-[#292929] mb-4">
        ...
        <div>
          <button
            type="button"
            class="border-2 border-mainColor dark:text-white font-semibold text-black hover:bg-mainColor hover:text-white focus:ring-4 transition duration-300 ease-out hover:ease-in rounded-full text-sm px-9 py-4 mb-2"
          >
            Learn More
          </button>
        </div>
